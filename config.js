...
global.sudo = process.env.SUDO || "22368432226";
global.owner = process.env.OWNER_NUMBER || "22368432226";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "𝗧𝗢𝗫𝗫𝗜𝗖 𝗕𝗢𝗬_×᷼×🕸️",
  packname: process.env.PACK_NAME || "𝒟𝒜ℛ𝒦-𝒪𝒰𝒮ℳ𝒜𝒩ℰ_×᷼×🕸️",
  botname: process.env.BOT_NAME || "𝒟𝒜ℛ𝒦-𝒪𝒰𝒮ℳ𝒜𝒩ℰ_×᷼×🕸️-MD",
  ownername: process.env.OWNER_NAME || "𝒪𝒰𝒮ℳ𝒜𝒩ℰ_×᷼×🕸️",
